...
class RecetteController extends Controller
{
     ...
     *
     * @Route("/", name="dashboard_recette_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("/ajout", name="dashboard_recette_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('dashboard_recette_show', array('id' => $recette->getId()));
        }
     ...
     *
     * @Route("/affichage/{id}", name="dashboard_recette_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/modicifation/{id}", name="dashboard_recette_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Recette $recette)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('dashboard_recette_edit', array('id' => $recette->getId()));
        }
     ...
     *
     * @Route("/{id}", name="dashboard_recette_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Recette $recette)
    {
        ...
        return $this->redirectToRoute('dashboard_recette_index');
    }
    ...
    private function createDeleteForm(Recette $recette)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('dashboard_recette_delete', array('id' => $recette->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
